      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-6 md:py-32">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
            ...
            <FadeIn delay={0.6}>
              <div className="mt-12 flex items-center gap-4 p-4 rounded-2xl bg-violet-600/5 border border-violet-500/10 max-w-sm group cursor-pointer hover:border-violet-500/30 transition-all">
                <div className="w-12 h-12 rounded-xl bg-violet-600/10 flex items-center justify-center shrink-0">
                  <Sparkles className="w-5 h-5 text-violet-500" />
                </div>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-violet-500 mb-0.5">Featured Work</p>
                  <a href="/projects/villa-booking-platform" className="text-sm font-semibold group-hover:text-violet-500 transition-colors flex items-center gap-1">
                    The Pushpa Heritage
